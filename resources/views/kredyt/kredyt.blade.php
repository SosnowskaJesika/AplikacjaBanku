        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Kredyty</h4>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                <li class="breadcrumb-item"><a href="/panel" class="text-muted">Panel</a></li>
                                <li class="breadcrumb-item text-muted active" aria-current="page">Weź kredyt</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>Weź kredyt aż do 10000 zł już teraz!</div>
                            <form enctype="multipart/form-data" method="post" action="/panel/kredyt-wez">
                                @csrf <!-- {{ csrf_field() }} -->
                                <label>
                                    Kwota kredytu
                                    <input type="number" name="kwota" max="10000"/>
                                </label>
                                <button class="btn btn-info">POTWIERDŹ</button>
                            </form>
                        </div>
                    </div>
                </div>
